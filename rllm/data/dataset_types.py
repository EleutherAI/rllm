...
class TrainDataset:
    ...
    class Code(enum.Enum):
        ...
        PRIMEINTELLECT_VULN = "PRIMEINTELLECT_VULN"
        PRIMEINTELLECT_ENCOURAGE = "PRIMEINTELLECT_VULN_ENCOURAGED"
        TACO_VULN = "TACO_VULN"
        TACO_ENCOURAGE = "TACO_VULN_ENCOURAGED"
        LIVECODEBENCH_VULN = "LIVECODEBENCH_VULN"
        LIVECODEBENCH_ENCOURAGE = "LIVECODEBENCH_VULN_ENCOURAGED"
        KODCODE = "KODCODE"
